 ...
 */
*}
{sugar_include type="smarty" file="modules/AM_ProjectTemplates/tpls/PopupHeader.tpl"}
...
{sugar_include type="smarty" file="modules/AM_ProjectTemplates/tpls/PopupFooter.tpl"}