...
class CalendarGrid
{
    // Calendar object
    protected $cal;
    // Style of calendar (basic or advanced); advanced contains time slots
    public $style = "";
    // Timestamp of today
    protected $today_ts;
    // String array of names of week days
    protected $weekdays;
    // First day of week
    protected $startday;
        ...
        if ($days) {
            foreach ($days as $day) {
                ...
                if ($day == $this->today_ts) {
                    $str .= "<div class='mobile_calendar_title today'><b>Today</b> " . date("D dS, M Y",
                            $agenda_array[$day][0]['ts_start']) . "</div>";
                } else {
                    $str .= "<div class='mobile_calendar_title'>" . date("D dS, M Y",
                            $agenda_array[$day][0]['ts_start']) . "</div>";
                }
