        ...
        if ($inherit == 'BLOCK') {
		  ...
		  if (isset($this->mpdf->blk[$this->mpdf->blklvl-1]['line_height']) && $this->mpdf->blk[$this->mpdf->blklvl-1]['line_height']) {
            ...
            if (isset($biilp[ 'toupper' ]) && $biilp[ 'toupper' ]) {
                ...
                if (isset($biilp[ 'tolower' ]) && $biilp[ 'tolower' ]) {
                    $p['TEXT-TRANSFORM'] = 'lowercase';
                } else {
                    if (isset($biilp[ 'capitalize' ]) && $biilp[ 'capitalize' ]) {
        ...
        if ($inherit == 'TOPLIST') {
            if ($this->listCSSlvl == 1) {
                ...
                if (isset($bilp[ 'toupper' ]) && $bilp[ 'toupper' ]) {
                    ...
                    if (isset($bilp[ 'tolower' ]) && $bilp[ 'tolower' ]) {
                        $p['TEXT-TRANSFORM'] = 'lowercase';
                    } else {
                        if (isset($bilp[ 'capitalize' ]) && $bilp[ 'capitalize' ]) {
                            $p['TEXT-TRANSFORM'] = 'capitalize';
                        }
                    }
                }
