...
class MBModule
{
    ...
    public function setModStrings($language = 'en_us', $mod_strings = array())
    {
        $language .= '.lang.php';
        $this->mblanguage->strings [$language] = $mod_strings;
    }

    public function setLabel($language = 'en_us', $key, $value = null)
    {
        $language .= '.lang.php' ;
    ...
    public function deleteLabel($language = 'en_us', $key = null)
    {
        foreach ($this->mblanguage->strings as $lang => $values) {
            if (!empty($values[$key])) {
    ...
    public function getLabel($language = 'en_us', $key = null)
    {
        $language .= '.lang.php' ;
    ...
    public function setAppListStrings($language = 'en_us', $app_list_strings = array())
    {
        $language .= '.lang.php' ;
        $this->mblanguage->appListStrings [ $language ] = $app_list_strings ;
    }

    public function setDropDown($language = 'en_us', $key = null, $value = null)
    {
        $language .= '.lang.php' ;
        $this->mblanguage->appListStrings [ $language ] [ $key ] = $value ;
    }

    public function deleteDropDown($language = 'en_us', $key = null)
    {
        $language .= '.lang.php' ;
