...
class SugarWidgetSubPanelTopComposeEmailButton extends SugarWidgetSubPanelTopButton
{
	...
	function display($defines, $additionalFormFields = NULL, $nonbutton = false)
	{
		...
		global $app_strings,$current_user,$sugar_config,$beanList,$beanFiles, $focus;
		...
		if($client != 'sugar') {
            ...
            $button = "<input title='$title'  id='". $this->getWidgetId()."'  onclick='$emailLink' class='button' type='submit' name='".preg_replace('[ ]', '', $value)."_button' value='$value' />";
		}
		return $button;
	}
}
